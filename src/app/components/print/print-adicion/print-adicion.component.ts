...
@Component({
  selector: 'app-print-adicion',
  standalone: true,
  imports: [ClassImports, MaterialModule],
  templateUrl: './print-adicion.component.html',
  styleUrl: './print-adicion.component.scss'
})
export class PrintAdicionComponent {
  @Input() data!: any;
    ...
    this.adicionService
      ...
      .subscribe((resp: any) => {
        ...
        setTimeout(() => {
          ...
          const printContents =
            document.getElementById('print-adicion-doc')?.innerHTML;
